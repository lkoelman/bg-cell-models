...
def get_interpolation_path_sections(reduction):
	...
	end_sec =  # TODO: choose a representative terminal section?
...
def set_ion_styles(reduction):
	...
	"""
	# Set ion styles
	# TODO: measure ion styles, see redutils.copy_ion_styles
...
def balbi_marasco_reduction(tweak=True):
	...
	import balbi_model
	BALBI_CELL_ID = 1
	named_secs = balbi_model.make_cell_balbi(model_no=BALBI_CELL_ID)
