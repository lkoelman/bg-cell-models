...
Original from Khaliq et al., J.Neurosci. 23(2003)4899
...
{
 : TABLE alfac,btfac,f01,f02,f03,f04,f0O,fip,f11,f12,f13,f14,f1n,fi1,fi2,fi3,fi4,fi5,fin,b01,b02,b03,b04,b0O,bip,b11,b12,b13,b14,b1n,bi1,bi2,bi3,bi4,bi5,bin DEPEND celsius FROM -100 TO 100 WITH 400
 alfac = (Oon/Con)^(1/4)
 btfac = (Ooff/Coff)^(1/4) 
